...
<html lang="en">
  ...
  <head>
    ...
    <meta name="author" content="Francisco Javier Muñoz Navarro">
    <link href="https://fonts.googleapis.com/css?family=Raleway:100,200,300,400,500,600,700,800,900&display=swap" rel="stylesheet">

    <title>Saoi Tech Solutions</title>
...
-->
    ...
    <div class="main-banner header-text" id="top">
        <div class="Modern-Slider">
          ...
          <div class="item">
            <div class="img-fill">
                <img src="assets/images/geom_turquoise.jpg" alt="">
                <div class="text-content">
                  <h3>Welcome To Saoi</h3>
                  <h5>AI Solutions For Business</h5>
          ...
          <div class="item">
            <div class="img-fill">
                <img src="assets/images/geom_blue.jpg" alt="">
                <div class="text-content">
          ...
          <div class="item">
            <div class="img-fill">
                <img src="assets/images/geom_purple.jpg" alt="">
                <div class="text-content">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="left-text-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <a href="#branches" class="main-button-icon">
                ...
                <div class="col-lg-6 col-md-6 col-xs-12">
                    <div class="right-text-content">
                        <p>Saoi Tech Solutions provides businesses with the most cutting-edge Artificial Intelligence custom solutions. Either if you are a top brand or a small startup, we will help you improve your workflow.
                        <br><br>Reaching a bigger audience, analyzing company data or accurate forecasting are not straightforward tasks. Let us create your next best work tool.
                      <br><br>This is Saoi Tech Solutions. You can feel free to <a rel="nofollow noopener" href="#contact-us" target="_parent">talk to us</a> for your next amazing project.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <div class="features-item">
                        ...
                        <div class="features-content">
                            <h4>Initial Work</h4>
                            <p>We will listen to your company's problems and provide personalized approaches in order to solve them.</p>
                            <a href="#projects" class="text-button-icon">
                                Learn More <i class="fa fa-arrow-right"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter bottom move 30px over 0.6s after 0.4s">
                    <div class="features-item">
                        ...
                        <div class="features-content">
                            ...
                            <p>Your project will be strategically planned, focusing on time and resource optimization.</p>
                            <a href="#projects" class="text-button-icon">
                                Learn More <i class="fa fa-arrow-right"></i>
                            </a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12" data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                    <div class="features-item">
                        ...
                        <div class="features-content">
                            ...
                            <p>We take advantage of the latest technologies, and create high-quality, trustable software for any industry.</p>
                            <a href="#projects" class="text-button-icon">
                                Learn More <i class="fa fa-arrow-right"></i>
                            </a>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="subscribe-content">
                        <p>We will keep you updated on the latest AI trends and projects to help you grow your business. Your data will be treated as strictly confidential.</p>
    ...
    <section class="section" id="branches">
        <div class="container">
			<div class="left-text-content">
                <div class="section-heading">
                    <h6>Projects</h6>
                    <h2>We adopt the latest technology stack</h2>
                </div>
            </div>
            <div class="col">
				<div class="row">
					...
					<div class="col-lg-8 col-md-12 col-sm-24 col-xs-24" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
						<div class="features-item">
							...
							<div class="features-content">
								...
								<p>Machine Learning can help you solve almost any problem: from real-time image classification to time series analysis. We are experts in this topic and will find the best suiting solutions for your company.</p>
							</div>
						</div>
					</div>
					...
					<div class="col-lg-8 col-md-12 col-sm-24 col-xs-24" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
						<div class="features-item">
							...
							<div class="features-content">
								...
								<p>Apps are everywhere! Take you business to higher level and impress your audience with beatiful, well designed apps in a wide range of possibilities.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"></div>
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-12 col-sm-24 col-xs-24" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
						<div class="features-item">
							...
							<div class="features-content">
								<h4>Big Data</h4>
								<p>Most companies have plenty of useful data that remains unused. We will help you exploit it and find useful patterns for data-driven business management.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"></div>
					...
					<div class="col-lg-8 col-md-12 col-sm-24 col-xs-24" data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
						<div class="features-item">
							...
							<div class="features-content">
								...
								<p>A well designed website is the first step for getting noticed. <a rel="nofollow noopener" href="#contact-us" target="_parent">Get in touch</a> and check out all the possibilities.</p>
							</div>
						</div>
					</div>
					<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"></div>
...
<!-- PROJECTS
    ...
    <!-- ***** Testimonials Ends ***** -->
	    ...
	    <!-- ***** Features Big Item Start ***** -->
    <section class="section" id="end-banner">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="section-heading">
            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8 col-xs-12">
                    <div class="contact-form">
							<form id="contact" action="./assets/php/email.php" method="post">
							  <div class="row">
								...
								<div class="col-lg-12">
								  <fieldset>
									<button type="submit" id="form-submit" class="main-button-icon">Send Message<i class="fa fa-arrow-right"></i></button>
								  </fieldset>
								</div>
							  </div>
							</form>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-xs-12">
                    <div class="left-text-content">
                        <p>Copyright &copy; 2020 Saoi Tech Solutions.</p>
                    </div>
                </div>
                <div class="col-lg-6 col-xs-12">
                    <div class="right-text-content">
